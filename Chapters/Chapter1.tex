...
% The aim of this thesis project was to improve the methods by which these centerline measurements were gathered and analyzed so as to reduce experimenter input and minimize errors introduced by this inter-frame movement. 
