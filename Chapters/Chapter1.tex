...
Another common mode of interframe movement is represented similarly in Figure \ref{fig:MovementCartoon}. This is movement of the tip of the pharynx dorsal-ventrally. Dorsal-ventral tip movements result in a loss of information about the tip in one frame, as depicted in red.

During imaging, animals are paralyzed with the actyl choline agonist levamisole. However, complete paralysis is not possible due to concentration limitations\todo{talk about limitations}. Inter-frame movement is currently addressed by visually screening the the ratio images for a highly textured appearence, as shown in Figure \ref{fig:HighMovement}. These animals are excluded from analysis. However, visual screening is a time-intensive process, requires training, and is subject to experimenter error and bias.
...
\todo[inline]{figure of midline that needs correction}
